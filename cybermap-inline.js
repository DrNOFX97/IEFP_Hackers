...
// ── EVENT LISTENERS (externalized from inline on* attributes, CSP hardening) ──
document.getElementById('btn-tweaks').addEventListener('click', toggleTweaks);
document.getElementById('fs-btn').addEventListener('click', toggleFS);
document.getElementById('frow-attacks').addEventListener('click', () => toggleFilter('attacks'));
document.getElementById('frow-flows').addEventListener('click', () => toggleFilter('flows'));
document.getElementById('frow-cables').addEventListener('click', () => toggleFilter('cables'));
document.getElementById('frow-cdn').addEventListener('click', () => toggleFilter('cdn'));
document.getElementById('an-close').addEventListener('click', closeAnom);
document.getElementById('tw-rot-speed').addEventListener('input', function () {
  rotSpeed = +this.value;
  this.nextElementSibling.textContent = this.value + '×';
});
document.getElementById('tw-arc-intensity').addEventListener('input', function () {
  arcIntensity = +this.value;
  this.nextElementSibling.textContent = this.value + '×';
});
document.getElementById('tw-arc-height').addEventListener('input', function () {
  arcHeight = +this.value;
  this.nextElementSibling.textContent = this.value;
});
document.getElementById('frow-autorotate').addEventListener('click', function () {
  autoRotate = !autoRotate;
  this.querySelector('.tgl').classList.toggle('on');
});
document.getElementById('frow-clouds').addEventListener('click', function () {
