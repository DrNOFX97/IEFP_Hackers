        ...
        const SKILLS_CATEGORIES = [
            ...
            { key: 'security-concepts', icon: '🛡️', label: 'Security Concepts', items: [
                { key: 'cia-triad', icon: '🔺', label: 'CIA Triad', status: 'soon' },
                { key: 'firewalls', icon: '🧱', label: 'Firewalls', status: 'soon' },
                { key: 'ids-ips', icon: '🚨', label: 'IDS / IPS', status: 'soon' },
                { key: 'vpn-proxies', icon: '🕵️', label: 'VPN & Proxies', status: 'soon' },
            ] },
            ...
            { key: 'databases', icon: '🗄️', label: 'Databases', items: [
                ...
                { key: 'nosql', icon: '🍃', label: 'NoSQL', status: 'soon' },
                { key: 'pyspark', icon: '⚡', label: 'PySpark', status: 'soon' },
                { key: 'hadoop', icon: '🐘', label: 'Hadoop', status: 'soon' },
            ] },
            { key: 'web-security', icon: '🌐', label: 'Web Security', items: [
                { key: 'owasp-top10', icon: '🔟', label: 'OWASP Top 10', status: 'soon' },
                { key: 'sql-injection', icon: '💉', label: 'SQL Injection', file: 'kali/sqlmap.html', status: 'ready' },
                { key: 'xss-csrf', icon: '🧬', label: 'XSS & CSRF', status: 'soon' },
